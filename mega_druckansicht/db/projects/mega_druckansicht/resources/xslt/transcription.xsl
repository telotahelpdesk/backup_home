<xsl:stylesheet xmlns:exist="http://exist.sourceforge.net/NS/exist" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:telota="http://www.telota.de" xmlns:tei="http://www.tei-c.org/ns/1.0" exclude-result-prefixes="tei exist telota" version="2.0">
        ...
        <xsl:choose>
            <xsl:when test="@cert='low'">
                <span class="tooltip">
                    ...
                    <a href="http://telotadev.bbaw.de/mega/register/personen/detail.xql?id={$id}">
                        <xsl:apply-templates mode="#current"/>
                    </a>
                </span>
            </xsl:when>
    ...
    <xsl:template mode="#all" match="tei:orgName">
        <a href="http://telotadev.bbaw.de/mega/register/einrichtungen/detail.xql?id={./@key}">
            <xsl:apply-templates mode="#current"/>
        </a>
    </xsl:template>
    <xsl:template mode="#all" match="tei:placeName">
        <a href="http://telotadev.bbaw.de/mega/register/orte/detail.xql?id={./@key}">
            <xsl:apply-templates mode="#current"/>
        </a>
    </xsl:template>
    ...
    <xsl:template mode="#all" match="tei:bibl[@sameAs and not(ancestor::tei:seg and ancestor::tei:note)]">
        <a href="http://telotadev.bbaw.de/mega/register/werke/detail.xql?id={./@sameAs}">
            <xsl:apply-templates mode="#current"/>
        </a>
    </xsl:template>
    <xsl:template mode="#all" match="tei:bibl[@sameAs and ancestor::tei:seg and ancestor::tei:note]">
        <a class="bibl" href="http://telotadev.bbaw.de/mega/register/werke/detail.xql?id={./@sameAs}">
            <xsl:apply-templates mode="#current"/>
        </a>
    </xsl:template>
    <xsl:template mode="#all" match="tei:date">
        <a href="http://telotadev.bbaw.de/mega/zeit/zeitsuche_ergebnis.xql?datum={./@when}">
            <xsl:apply-templates mode="#current"/>
        </a>
    </xsl:template>
    ...
    <xsl:template mode="#all" match="tei:rs[@type='letter']">
        <xsl:choose>
            <xsl:when test="@type='erschlossenerBrief'">
                <span class="rs">
                    <xsl:apply-templates mode="#current"/>
                    <a class="erschlossenerBrief" href="http://telotadev.bbaw.de/mega/briefe/detail.xql?id={@key}" title="Zum erschlossenen Brief">
            ...
            <xsl:otherwise>
                <span class="rs">
                    <xsl:apply-templates mode="#current"/>
                    <a class="brief" href="http://telotadev.bbaw.de/mega/briefe/detail.xql?id={@key}" title="Zum Volltext des Briefes">
        ...
        <xsl:variable name="target">
            <xsl:choose>
                ...
                <xsl:when test="matches(@target, '/')">
                    <xsl:text>http://telotadev.bbaw.de/mega/briefe/detail.xql?id=</xsl:text>
