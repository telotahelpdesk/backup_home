...
let $content := <transferContainer>
                    <div class="grid_11 box whitebox impressum">
                        <div class="boxInner">
                            ...
                            <h4>Wissenschaftliche Bearbeitung</h4>
                            <p>Dr. Uta Motschmann<br/><a href="mailto:motschmann@bbaw.de">motschmann@bbaw.de</a></p>
                            ...
                            <iframe style="border: 0; height: 2200px; width: 600px;" src="https://dschutz.bbaw.de/"/>
                            <iframe style="border: 0; height: 200px; width: 600px;" src="https://piwik.bbaw.de/index.php?module=CoreAdminHome&amp;action=optOut&amp;language=de">&#160;</iframe>
                        </div>
                    </div>
                 </transferContainer>
...
let $output := edweb:transformHTML($xslt_input, 'impressum', 'Impressum') 
