...
let $header :=  <transferContainer>
                    <h1>Suche in den Manuskripten</h1>
                    <p></p>
                </transferContainer>
...
let $content := <transferContainer>
                  <div class="grid_8">
                    <div class="box whitebox">
                        <div class="boxInner">
                             <h3>Briefe &amp; amtliche Schriften</h3>
                             {edwebSearch:formBriefsuche($param_q_text, $param_q_title, $param_q_abstract, $param_q_note, $q_korrespondent, $isoStartDate, $isoEndDate)}    
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="grid_4 box graybox">
                        <div class="boxInner">
                            <h3>Tipps zur Suche in den drei Manuskriptsorten</h3>
