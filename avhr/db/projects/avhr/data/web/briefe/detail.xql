...
(:Nachweis, d.h. Archiv und Signatur :)
 let $nachweis :=
    ...
    then 'H: '
    else if ($letter//tei:msDesc[@rend='concept'])
    then 'h: '
    ...
    then (
        ...
        <p id="nachweis">
            {if ($letter//tei:msDesc//tei:idno/text()!='') then (
                concat($typeOfMs, $letter//tei:msDesc[@rend='manuscript' or @rend='concept']/tei:msIdentifier/tei:institution,
                edweb:seperator($letter//tei:msDesc[@rend='manuscript' or @rend='concept']/tei:msIdentifier/tei:repository/text(), ', '),
                edweb:seperator($letter//tei:msDesc[@rend='manuscript' or @rend='concept']/tei:msIdentifier/tei:collection/text(), ', '),
                edweb:seperator($letter//tei:msDesc[@rend='manuscript' or @rend='concept']/tei:msIdentifier/tei:idno[not(@type='kalliope')]/text(), ','),
                edweb:seperator($letter//tei:msDesc[@rend='manuscript' or @rend='concept']/tei:msIdentifier/tei:idno/tei:idno[@type='shelfmark']/text(), ',')),
...
let $header :=  
    <transferContainer>
        <div id="subnavbar">
            ...
            <li><a class="index" href="index.xql?person={$person}&amp;view={$edweb:p_view}">Korrespondenz mit {edweb:persName(collection($edweb:dataRegister)//tei:person[@xml:id=$person][1]/tei:persName[not(./@type='alt')], 'forename')}</a></li>
